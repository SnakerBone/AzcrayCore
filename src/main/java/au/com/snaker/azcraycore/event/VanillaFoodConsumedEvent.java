...
public class VanillaFoodConsumedEvent {
    public static void executeEvent(LivingEntity entity) {
        if(entity instanceof PlayerEntity) {
            ITextComponent vanillaFoodConsumedStatus = new TranslationTextComponent("status.azcraycore.vanilla_food_consumed");
            ...
            entity.addPotionEffect(new EffectInstance(AzcrayCoreEffectInit.TELEPORT.get(), 250, 1));
        }
    }
}
